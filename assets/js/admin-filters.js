...
(function($) {
    ...
    class CertFilterManager {
        ...
        updatePreview() {
            ...
            console.log('=== CERTIFICATE FILTER DEBUG ===');
            console.log('Filters object:', JSON.stringify(this.filters, null, 2));
            console.log('Skip already sent checkbox:', $('#cert-filter-skip-sent').is(':checked'));
            console.log('Email status checkboxes:', $('input[name="email_status[]"]:checked').map(function() { return $(this).val(); }).get());
            console.log('Post types selected:', $('#cert-filter-post-types').val());
            console.log('================================');
        ...
        renderPreview(data) {
            ...
            console.log('Has recipients:', !!data.recipients);
            console.log('====================');
