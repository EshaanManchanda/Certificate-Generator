...
class CG_Analytics_Dashboard {
	...
	public function enqueue_assets( $hook ) {
		...
		wp_enqueue_style( 'cg-analytics-css', CERTIFICATE_GENERATOR_URL . 'assets/css/analytics-style.css', array(), '1.0.0' );
		...
		<div class="wrap cg-analytics-page">
			...
			<div class="cg-reports-section">
				...
				<div class="cg-report-actions">
					<a href="<?php echo esc_url( admin_url( 'admin-ajax.php?action=cg_export_expiration_report&nonce=' . wp_create_nonce( 'cg_export_nonce' ) ) ); ?>" class="button button-primary">
						Export Expiration Report (CSV)
					</a>
					<a href="<?php echo esc_url( admin_url( 'admin-ajax.php?action=cg_export_monthly_report&nonce=' . wp_create_nonce( 'cg_export_nonce' ) ) ); ?>" class="button button-secondary">
