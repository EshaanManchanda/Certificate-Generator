...
function cg_ajax_deactivate_license(): void {
    ...
    wp_send_json_success( [ 'message' => __( 'License deactivated. Plan reverted to Free.', 'certificate-generator' ) ] );
}
...
function cg_render_license_tab(): void {
    ...
    <div class="cg-license-wrap">
        ...
        <!-- ── 5. UPGRADE BANNER (shown only on Free / Pro) ── -->
        <?php if ( ! CG_License_Manager::is_business() ) : ?>
