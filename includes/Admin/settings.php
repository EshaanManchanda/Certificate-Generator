...
add_action('wp_ajax_cg_send_smtp_test', function () {
            ...
            <div class="cg-api-wrap">
                ...
                <div class="cg-endpoint">
                    ...
                    <div class="cg-endpoint-body">
                        ...
                        <strong style="font-size:12px;text-transform:uppercase;color:#444;"><?php esc_html_e('Example Request', 'certificate-generator'); ?></strong>
                        <div class="cg-code-block" id="cg-code-byemail"><?php
...
add_action('wp_ajax_cg_pdf_integrity_check', function () {
    check_ajax_referer('cg_pdf_integrity_check', 'nonce');
    if (!current_user_can('manage_options')) wp_die('Forbidden', 403);

    if (!class_exists('\CertificateGenerator\Database\CustomTables')) {
        wp_send_json_error(['message' => 'CustomTables class not available.']);
    }
...
add_action('wp_ajax_cg_preview_template', function () {
    ...
    if (!$tmpl) wp_die('Template not found (ID: ' . $template_id . ').');
    ...
    // Build dummy student data — preview uses the saved field positions.
    $post_data = [
        ...
        '_preview_post_id'  => $template_id, // signals non-strict template lookup
    ];
