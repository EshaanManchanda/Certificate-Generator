...
// Add admin menu for email logs
add_action('admin_menu', 'certificate_generator_add_email_logs_menu');
function certificate_generator_add_email_logs_menu() {
    add_submenu_page(
        'options-general.php',
        __('Email Logs', 'certificate-generator'),
        __('Email Logs', 'certificate-generator'),
        'manage_options',
