...
add_action('save_post_students', 'cg_sync_to_dynamic_tags');
add_action('save_post_teachers', 'cg_sync_to_dynamic_tags');
add_action('save_post_schools', 'cg_sync_to_dynamic_tags');
        ...
        <div class="cg-student-card">
            ...
            <div class="custom-form-group">
                ...
                <input type="date" id="issue_date" name="issue_date"
                    value="<?php echo esc_attr($issue_date); ?>"
    ...
    <div class="custom-form-wrap">
        ...
        <div class="custom-form-group">
            ...
            <input type="date" id="event_date" name="event_date"
                value="<?php echo esc_attr(get_post_meta($post->ID, 'event_date', true)); ?>" class="custom-form-input">
            <p class="description">Set this when multiple templates share the same certificate type (e.g., Dec 2025 vs Mar
                2026). Leave blank if this is the only template for this type.</p>
        </div>
