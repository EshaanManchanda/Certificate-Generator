...
class CertificateGenerator_InstallationDebug {
    ...
    public function test_installation_requirements() {
        ...
        // Test 2: Memory Limit
        $memory_limit = ini_get('memory_limit');
        $memory_bytes = certificate_generator_convert_to_bytes($memory_limit);
    ...
    public function generate_debug_report() {
        $report = array(
            ...
            'session_duration' => certificate_generator_get_session_duration(),
    ...
    private function store_debug_entry($message, $level, $context) {
        ...
        $entries[] = array(
            ...
            'context' => $context,
            'step' => $this->current_step,
            'memory' => certificate_generator_get_memory_usage()
        );
