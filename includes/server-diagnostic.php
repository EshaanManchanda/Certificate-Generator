...
class CertificateGenerator_ServerDiagnostic {
    ...
    private function analyze_file_system() {
        ...
        if (function_exists('disk_free_space')) {
            ...
            if ($free_space !== false) {
                $analysis['disk_free_space'] = $this->format_bytes($free_space);
            }
        }
        ...
        if (function_exists('disk_total_space')) {
            ...
            if ($total_space !== false) {
                $analysis['disk_total_space'] = $this->format_bytes($total_space);
            }
        }
    ...
    private function analyze_resource_usage() {
        return array(
            ...
            'memory_peak' => $this->get_peak_memory_usage(),
            'memory_limit' => ini_get('memory_limit'),
    ...
    private function generate_recommendations() {
        ...
        $memory_limit = $this->convert_to_bytes($this->diagnostic_results['php_configuration']['memory_limit']);
    ...
    private function get_peak_memory_usage() {
        if (function_exists('memory_get_peak_usage')) {
            return $this->format_bytes(memory_get_peak_usage(true));
        }
        return 'Unknown';
    }
