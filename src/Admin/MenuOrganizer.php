...
class MenuOrganizer {
    ...
    public function render_bulk_import(): void {
        ...
        $this->render_tabs('Bulk Import', ['students' => 'Students', 'teachers' => 'Teachers', 'schools' => 'Schools', 'certificates' => 'Certificates'], $tab, function($t) {
            switch ($t) {
                case 'students':   bulk_import_students_form(); break;
                case 'teachers':   bulk_import_teachers_form(); break;
                case 'schools':    bulk_import_schools_form(); break;
                case 'certificates': bulk_import_certificates_form(); break;
            }
        });
    }
    ...
    public function render_bulk_export(): void {
        ...
        $tab = sanitize_key($_GET['tab'] ?? 'students');
        $this->render_tabs('Bulk Export', ['students' => 'Students', 'teachers' => 'Teachers', 'schools' => 'Schools', 'certificates' => 'Certificates'], $tab, function($t) {
            switch ($t) {
