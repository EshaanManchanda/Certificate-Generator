...
class Plugin {
    ...
    private function register_services(): void {
        ...
        $this->container->singleton(Expiration::class, function() {
            return new Expiration();
        });

        $this->container->singleton(CertificateService::class, function($c) {
            return new CertificateService($c->make(Expiration::class));
        });

        $this->container->singleton(SerialNumberService::class, function() {
            return new SerialNumberService();
        });

        $this->container->singleton(QRCodeService::class, function() {
        ...
        $this->container->singleton(GemaAPI::class, function() {
