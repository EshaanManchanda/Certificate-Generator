...
class CptToSqlMigration {
    ...
    public function __construct() {
        ...
        $this->stats = [
            ...
            'templates' => 0, 'certificates' => 0, 'email_logs' => 0,
        ];
    }
    ...
    private function migrate_schools(): void {
        ...
        $schools = get_posts(['post_type' => 'schools', 'posts_per_page' => -1, 'post_status' => 'any']);
    ...
    private function migrate_students(): void {
        ...
        $students = get_posts(['post_type' => 'students', 'posts_per_page' => -1, 'post_status' => 'any']);
    ...
    private function migrate_teachers(): void {
        ...
        $teachers = get_posts(['post_type' => 'teachers', 'posts_per_page' => -1, 'post_status' => 'any']);
    ...
    private function migrate_templates(): void {
        ...
        $templates = get_posts(['post_type' => 'certificates', 'posts_per_page' => -1, 'post_status' => 'any']);
    ...
    private function extract_extra_fields(string $entity_type, array $meta): array {
        $core_keys = [
            'schools' => ['school_name', 'school_address', 'school_city', 'school_state', 'school_country', 'school_postal_code', 'school_phone', 'school_email', 'school_website', 'school_principal', '_edit_last', '_edit_lock'],
            'students' => ['student_name', 'email', 'phone', 'school_name', 'enrollment_date', 'graduation_date', '_edit_last', '_edit_lock'],
            'teachers' => ['teacher_name', 'email', 'phone', 'school_name', 'department', 'hire_date', '_edit_last', '_edit_lock'],
            'templates' => ['certificate_type', 'event_date', 'template_url', 'template_orientation', 'certificate_page_size', 'font_style', 'font_size', 'font_color', 'qr_enabled', 'qr_size', 'qr_position_x', 'qr_position_y', 'qr_error_correction', 'qr_data_fields', 'serial_number_display', 'serial_number_position_x', 'serial_number_position_y', 'serial_number_font_size', 'expiration_period_unit', 'expiration_period_value', '_edit_last', '_edit_lock'],
        ];

        $known = $core_keys[$entity_type] ?? [];
        $extra = [];
