...
class GemaAPI {
	...
	public function get_students( array $params = array() ): array {
		return $this->request( 'GET', '/students', $params );
	}

	public function get_teachers( array $params = array() ): array {
		return $this->request( 'GET', '/teachers', $params );
	}

	public function get_schools( array $params = array() ): array {
		return $this->request( 'GET', '/schools', $params );
	}

	public function get_certificates( array $params = array() ): array {
